...
with open("YC_RTValue.txt", "wb") as f:
    metadata, res = dbx.files_download(path="/thinktron/YC_RTValue.txt")
    f.write(res.content)

path = 'D:/Chou/Python/B2202/YC_RTValue.txt'
f = open(path, 'r')
print(f.read())
f.seek(0)
result = []
